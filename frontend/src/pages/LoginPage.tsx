...
import { Link2, LogIn, Lock, Mail, ArrowRight } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#f8f9fb] text-slate-800 flex flex-col justify-center items-center px-4">
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="text-center space-y-2">
          ...
          <h2 className="text-xl font-bold tracking-tight text-slate-800 pt-2">Welcome Back</h2>
          <p className="text-sm text-slate-500">Sign in to manage short URLs and access clickstream analytics.</p>
        </div>
        ...
        <div className="p-8 rounded-2xl bg-white border border-gray-200 shadow-sm">
          ...
          <div className="mt-6 pt-4 border-t border-gray-100 text-center text-sm text-slate-500">
            ...
            <Link to="/register" className="text-[#f36601] hover:text-brand-600 hover:underline font-semibold">
              Create one now
            </Link>
          </div>
        </div>
